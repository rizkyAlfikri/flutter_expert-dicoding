...
void main() {
  ...
  test('Initial state should be empty', () {
    expect(movieSearchBloc.state, MovieSearchEmptyState());
  });
  ...
  blocTest<MovieSearchBloc, MovieSearchState>(
      ...
      expect: () =>
          [MovieSearchLoadingState(), MovieSearchSuccessState(tMovieList)],
      verify: (bloc) {
  ...
  blocTest<MovieSearchBloc, MovieSearchState>(
      ...
      expect: () => [
            ...
            const MovieSearchErrorState('Server Failure'),
          ],
      wait: const Duration(milliseconds: 500),
      verify: (bloc) {
        verify(mockSearchMovies.execute(tQuery));
